...
const SecuritySettings = () => {
    ...
    return (
        <div className="w-full mx-auto p-6 max-w-screen-xl">
            <h2 className="text-4xl font-bold text-[#1c274c]">Security Settings</h2>
            <div className={`bg-white shadow-md rounded-lg p-6`}>
                <div className={`mt-4 space-y-4`}>
                    <div>
                        <label className="block text-[18px] font-semibold  text-[#1c274c]">Two-step verification</label>
                    ...
                    <div className="mt-4 border-t pt-4">
                        <label className="block text-[18px] font-semibold  text-[#1c274c]" >Log out of all devices</label>
